...
bottomArea.text(171, 240, 'オ').click(playAud01).attr({
  'font-size': 100,
  'cursor': 'pointer'
});
...
g_oilu.use().transform('t145, 385').click(playAud02).appendTo(bottomArea).attr({
  'cursor': 'pointer'
});

var t12 = bottomArea.text(185, 520, ['オ', 'イル', '기름']).click(playAud02).attr({
  'font-size': 25,
  'cursor': 'pointer'
});
