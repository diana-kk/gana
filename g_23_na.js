...
bottomArea.text(171, 240, 'ナ').click(playAud01).attr({
  'font-size': 100,
  'cursor': 'pointer'
});
...
g_naasu.use().transform('t145 385').click(playAud02).appendTo(bottomArea).attr({
  'cursor': 'pointer'
});

var t12 = bottomArea.text(165, 520, ['ナ', 'ース', '간호사']).click(playAud02).attr({
  'font-size': 25,
  'cursor': 'pointer'
});
