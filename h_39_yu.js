...
bottomArea.text(171, 240, 'ゆ').click(playAud01).attr({
  'font-size': 100,
  'cursor': 'pointer'
});
...
h_yuki.use().transform('t130 390').click(playAud02).appendTo(bottomArea).attr({
  'cursor': 'pointer'
});

var t12 = bottomArea.text(200, 520, ['ゆ', 'き', '눈']).click(playAud02).attr({
  'font-size': 25,
  'cursor': 'pointer'
});
