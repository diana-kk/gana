...
bottomArea.text(171, 240, 'つ').click(playAud01).attr({
  'font-size': 100,
  'cursor': 'pointer'
});
...
h_tuti.use().transform('t135 385').click(playAud02).appendTo(bottomArea).attr({
  'cursor': 'pointer'
});

var t12 = bottomArea.text(200, 520, ['つ', 'ち', '흙']).click(playAud02).attr({
  'font-size': 25,
  'cursor': 'pointer'
});
