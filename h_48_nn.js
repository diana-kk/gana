...
topArea.text(22, 507, 'わ').click(handler10).attr({
  'font-size': 20,
  'fill': 'gray',
  'cursor': 'pointer'
});
...
topArea.text(22, 557, 'ん').click(hanlderLine).attr({
  'font-size': 20,
  'font-weight': 'bold',
  'cursor': 'pointer'
});
...
bottomArea.text(171, 220, 'ん').click(playAud01).attr({
  'font-size': 100,
  'cursor': 'pointer'
});
...
h_tonnbo.use().transform('t117 312').click(playAud02).appendTo(bottomArea).attr({
  'cursor': 'pointer'
});

var t01 = bottomArea.text(88, 412, ['と', 'ん', 'ぼ', '잠자리']).click(playAud02).attr({
  'font-size': 23,
  'fill': 'gray',
  'cursor': 'pointer'
});
...
h_onnna.use().transform('t250 312').click(playAud03).appendTo(bottomArea).attr({
  'cursor': 'pointer'
});

var t02 = bottomArea.text(233, 412, ['お', 'ん', 'な', '여자']).click(playAud03).attr({
  'font-size': 23,
  'fill': 'gray',
  'cursor': 'pointer'
});
...
h_rinngo.use().transform('t110 450').click(playAud04).appendTo(bottomArea).attr({
  'cursor': 'pointer'
});

var t03 = bottomArea.text(93, 552, ['り', 'ん', 'ご', '사과']).click(playAud04).attr({
  'font-size': 23,
  'fill': 'gray',
  'cursor': 'pointer'
});
...
h_honn.use().transform('t250 453').click(playAud05).appendTo(bottomArea).attr({
  'cursor': 'pointer'
});

var t04 = bottomArea.text(248, 552, ['ほ', 'ん', '책']).click(playAud05).attr({
  'font-size': 23,
  'fill': 'gray',
  'cursor': 'pointer'
});
