...
bottomArea.text(171, 240, 'き').click(playAud01).attr({
  'font-size': 100,
  'cursor': 'pointer'
});
...
h_ki.use().transform('t145, 385').click(playAud02).appendTo(bottomArea).attr({
  'cursor': 'pointer'
});

var t12 = bottomArea.text(210, 520, ['き', '나무']).click(playAud02).attr({
  'font-size': 25,
  'cursor': 'pointer'
});
