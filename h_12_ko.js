...
bottomArea.text(171, 240, 'こ').click(playAud01).attr({
  'font-size': 100,
  'cursor': 'pointer'
});
...
h_koi.use().transform('t125, 390').click(playAud02).appendTo(bottomArea).attr({
  'cursor': 'pointer'
});

var t12 = bottomArea.text(200, 520, ['こ', 'い', '잉어']).click(playAud02).attr({
  'font-size': 25,
  'cursor': 'pointer'
});
