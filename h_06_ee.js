...
bottomArea.text(171, 240, 'え').click(playAud01).attr({
  'font-size': 100,
  'cursor': 'pointer'
});
...
h_ee.use().transform('t135, 390').click(playAud02).appendTo(bottomArea).attr({
  'cursor': 'pointer'
});

var t12 = bottomArea.text(210, 520, ['え', '그림']).click(playAud02).attr({
  'font-size': 25,
  'cursor': 'pointer'
});
