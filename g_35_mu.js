...
bottomArea.text(171, 240, 'ム').click(playAud01).attr({
  'font-size': 100,
  'cursor': 'pointer'
});
...
g_muusu.use().transform('t130 385').click(playAud02).appendTo(bottomArea).attr({
  'cursor': 'pointer'
});

var t12 = bottomArea.text(185, 520, ['ム', 'ース', '무스']).click(playAud02).attr({
  'font-size': 25,
  'cursor': 'pointer'
});
