...
bottomArea.text(171, 240, 'か').click(playAud01).attr({
  'font-size': 100,
  'cursor': 'pointer'
});
...
h_kaki.use().transform('t150, 390').click(playAud02).appendTo(bottomArea).attr({
  'cursor': 'pointer'
});

var t12 = bottomArea.text(200, 520, ['か', 'き', '감']).click(playAud02).attr({
  'font-size': 25,
  'cursor': 'pointer'
});
