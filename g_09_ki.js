...
bottomArea.text(171, 240, 'キ').click(playAud01).attr({
  'font-size': 100,
  'cursor': 'pointer'
});
...
g_kii.use().transform('t130, 385').click(playAud02).appendTo(bottomArea).attr({
  'cursor': 'pointer'
});

var t12 = bottomArea.text(200, 520, ['キ', 'ー', '열쇠']).click(playAud02).attr({
  'font-size': 25,
  'cursor': 'pointer'
});
