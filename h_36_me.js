...
bottomArea.text(171, 240, 'め').click(playAud01).attr({
  'font-size': 100,
  'cursor': 'pointer'
});
...
h_me.use().transform('t135 400').click(playAud02).appendTo(bottomArea).attr({
  'cursor': 'pointer'
});

var t12 = bottomArea.text(210, 520, ['め', '싹']).click(playAud02).attr({
  'font-size': 25,
  'cursor': 'pointer'
});
