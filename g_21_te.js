...
bottomArea.text(171, 240, 'テ').click(playAud01).attr({
  'font-size': 100,
  'cursor': 'pointer'
});
...
g_tennto.use().transform('t130 385').click(playAud02).appendTo(bottomArea).attr({
  'cursor': 'pointer'
});

var t12 = bottomArea.text(175, 520, ['テ', 'ント', '텐트']).click(playAud02).attr({
  'font-size': 25,
  'cursor': 'pointer'
});
