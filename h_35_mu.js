...
bottomArea.text(171, 240, 'む').click(playAud01).attr({
  'font-size': 100,
  'cursor': 'pointer'
});
...
h_mushi.use().transform('t130 385').click(playAud02).appendTo(bottomArea).attr({
  'cursor': 'pointer'
});

var t12 = bottomArea.text(200, 520, ['む', 'し', '벌레']).click(playAud02).attr({
  'font-size': 25,
  'cursor': 'pointer'
});
