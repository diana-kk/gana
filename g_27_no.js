...
bottomArea.text(171, 240, 'ノ').click(playAud01).attr({
  'font-size': 100,
  'cursor': 'pointer'
});
...
g_nootoo.use().transform('t135 390').click(playAud02).appendTo(bottomArea).attr({
  'cursor': 'pointer'
});

var t12 = bottomArea.text(180, 520, ['ノ', 'ート', '노트']).click(playAud02).attr({
  'font-size': 25,
  'cursor': 'pointer'
});
