...
bottomArea.text(171, 240, 'シ').click(playAud01).attr({
  'font-size': 100,
  'cursor': 'pointer'
});
...
g_siisoo.use().transform('t135 390').click(playAud02).appendTo(bottomArea).attr({
  'cursor': 'pointer'
});

var t12 = bottomArea.text(165, 520, ['シ', 'ーソー', '시소']).click(playAud02).attr({
  'font-size': 25,
  'cursor': 'pointer'
});
