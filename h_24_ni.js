...
bottomArea.text(171, 240, 'に').click(playAud01).attr({
  'font-size': 100,
  'cursor': 'pointer'
});
...
h_nizi.use().transform('t130 390').click(playAud02).appendTo(bottomArea).attr({
  'cursor': 'pointer'
});

var t12 = bottomArea.text(185, 520, ['に', 'じ', '무지개']).click(playAud02).attr({
  'font-size': 25,
  'cursor': 'pointer'
});
