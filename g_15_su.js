...
bottomArea.text(171, 240, 'ス').click(playAud01).attr({
  'font-size': 100,
  'cursor': 'pointer'
});
...
g_suisu.use().transform('t135 390').click(playAud02).appendTo(bottomArea).attr({
  'cursor': 'pointer'
});

var t12 = bottomArea.text(165, 520, ['ス', 'イス', '스위스']).click(playAud02).attr({
  'font-size': 25,
  'cursor': 'pointer'
});
