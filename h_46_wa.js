...
bottomArea.text(171, 240, 'わ').click(playAud01).attr({
  'font-size': 100,
  'cursor': 'pointer'
});
...
h_wagashi.use().transform('t130 390').click(playAud02).appendTo(bottomArea).attr({
  'cursor': 'pointer'
});

var t12 = bottomArea.text(170, 520, ['わ', 'がし', '화과자']).click(playAud02).attr({
  'font-size': 25,
  'cursor': 'pointer'
});
