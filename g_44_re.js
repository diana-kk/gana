...
bottomArea.text(171, 240, 'レ').click(playAud01).attr({
  'font-size': 100,
  'cursor': 'pointer'
});
...
g_retaa.use().transform('t130 390').click(playAud02).appendTo(bottomArea).attr({
  'cursor': 'pointer'
});

var t12 = bottomArea.text(180, 520, ['レ', 'ター', '편지']).click(playAud02).attr({
  'font-size': 25,
  'cursor': 'pointer'
});
