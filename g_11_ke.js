...
bottomArea.text(171, 240, 'ケ').click(playAud01).attr({
  'font-size': 100,
  'cursor': 'pointer'
});
...
g_keeki.use().transform('t140, 385').click(playAud02).appendTo(bottomArea).attr({
  'cursor': 'pointer'
});

var t12 = bottomArea.text(165, 520, ['ケ', 'ーキ', '케이크']).click(playAud02).attr({
  'font-size': 25,
  'cursor': 'pointer'
});
