...
bottomArea.text(171, 240, 'も').click(playAud01).attr({
  'font-size': 100,
  'cursor': 'pointer'
});
...
h_mochi.use().transform('t135 400').click(playAud02).appendTo(bottomArea).attr({
  'cursor': 'pointer'
});

var t12 = bottomArea.text(200, 520, ['も', 'ち', '떡']).click(playAud02).attr({
  'font-size': 25,
  'cursor': 'pointer'
});
