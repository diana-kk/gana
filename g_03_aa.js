...
bottomArea.text(171, 240, 'ア').click(playAud01).attr({
  'font-size': 100,
  'cursor': 'pointer'
});
...
g_aisu.use().transform('t130, 390').click(playAud02).appendTo(bottomArea).attr({
  'cursor': 'pointer'
});

var t12 = bottomArea.text(183, 520, ['ア', 'イス', '얼음']).click(playAud02).attr({
  'font-size': 25,
  'cursor': 'pointer'
});
