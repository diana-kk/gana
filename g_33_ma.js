...
bottomArea.text(171, 240, 'マ').click(playAud01).attr({
  'font-size': 100,
  'cursor': 'pointer'
});
...
g_maiku.use().transform('t130 390').click(playAud02).appendTo(bottomArea).attr({
  'cursor': 'pointer'
});

var t12 = bottomArea.text(175, 520, ['マ', 'イク', '마이크']).click(playAud02).attr({
  'font-size': 25,
  'cursor': 'pointer'
});
