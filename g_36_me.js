...
bottomArea.text(171, 240, 'メ').click(playAud01).attr({
  'font-size': 100,
  'cursor': 'pointer'
});
...
g_melonn.use().transform('t135 385').click(playAud02).appendTo(bottomArea).attr({
  'cursor': 'pointer'
});

var t12 = bottomArea.text(185, 520, ['メ', 'ロン', '멜론']).click(playAud02).attr({
  'font-size': 25,
  'cursor': 'pointer'
});
