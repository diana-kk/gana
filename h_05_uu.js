...
// 행
topArea.text(22, 107, 'か').click(handler01).attr({
  'font-size': 20,
  'fill': 'gray',
  'cursor': 'pointer'
});
...
topArea.text(22, 157, 'さ').click(handler02).attr({
  'font-size': 20,
  'fill': 'gray',
  'cursor': 'pointer'
});
...
topArea.text(22, 207, 'た').click(handler03).attr({
  'font-size': 20,
  'fill': 'gray',
  'cursor': 'pointer'
});
...
topArea.text(22, 257, 'な').click(handler04).attr({
  'font-size': 20,
  'fill': 'gray',
  'cursor': 'pointer'
});
...
topArea.text(22, 307, 'は').click(handler05).attr({
  'font-size': 20,
  'fill': 'gray',
  'cursor': 'pointer'
});
...
topArea.text(22, 57, 'あ').click(hanlderLine).attr({
  'font-size': 20,
  'font-weight': 'bold',
  'cursor': 'pointer'
});
...
bottomArea.text(171, 240, 'う').click(playAud01).attr({
  'font-size': 100,
  'cursor': 'pointer'
});
...
h_ushi.use().transform('t135, 385').click(playAud02).appendTo(bottomArea).attr({
  'cursor': 'pointer'
});

var t12 = bottomArea.text(200, 520, ['う', 'し', '소']).click(playAud02).attr({
  'font-size': 25,
  'cursor': 'pointer'
});
