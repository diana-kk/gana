...
bottomArea.text(171, 240, 'ニ').click(playAud01).attr({
  'font-size': 100,
  'cursor': 'pointer'
});
...
g_nitto.use().transform('t140 385').click(playAud02).appendTo(bottomArea).attr({
  'cursor': 'pointer'
});

var t12 = bottomArea.text(185, 520, ['ニ', 'ット', '니트']).click(playAud02).attr({
  'font-size': 25,
  'cursor': 'pointer'
});
