...
bottomArea.text(171, 240, 'お').click(playAud01).attr({
  'font-size': 100,
  'cursor': 'pointer'
});
...
h_oi.use().transform('t145, 385').click(playAud02).appendTo(bottomArea).attr({
  'cursor': 'pointer'
});

var t12 = bottomArea.text(200, 520, ['お', 'い', '조카']).click(playAud02).attr({
  'font-size': 25,
  'cursor': 'pointer'
});
