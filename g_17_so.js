...
bottomArea.text(167, 240, 'ソ').click(playAud01).attr({
  'font-size': 100,
  'cursor': 'pointer'
});
...
g_sooseeji.use().transform('t135 385').click(playAud02).appendTo(bottomArea).attr({
  'cursor': 'pointer'
});

var t12 = bottomArea.text(127, 520, ['ソ', 'ーセージ', '소시지']).click(playAud02).attr({
  'font-size': 25,
  'cursor': 'pointer'
});
