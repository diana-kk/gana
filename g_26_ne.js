...
bottomArea.text(171, 240, 'ネ').click(playAud01).attr({
  'font-size': 100,
  'cursor': 'pointer'
});
...
g_nekutai.use().transform('t145 385').click(playAud02).appendTo(bottomArea).attr({
  'cursor': 'pointer'
});

var t12 = bottomArea.text(150, 520, ['ネ', 'クタイ', '넥타이']).click(playAud02).attr({
  'font-size': 25,
  'cursor': 'pointer'
});
