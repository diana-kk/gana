...
bottomArea.text(171, 240, 'セ').click(playAud01).attr({
  'font-size': 100,
  'cursor': 'pointer'
});
...
g_seetaa.use().transform('t135 390').click(playAud02).appendTo(bottomArea).attr({
  'cursor': 'pointer'
});

var t12 = bottomArea.text(150, 520, ['セ', 'ーター', '스웨터']).click(playAud02).attr({
  'font-size': 25,
  'cursor': 'pointer'
});
