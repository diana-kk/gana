...
bottomArea.text(171, 240, 'り').click(playAud01).attr({
  'font-size': 100,
  'cursor': 'pointer'
});
...
h_risu.use().transform('t130 390').click(playAud02).appendTo(bottomArea).attr({
  'cursor': 'pointer'
});

var t12 = bottomArea.text(186, 520, ['り', 'す', '다람쥐']).click(playAud02).attr({
  'font-size': 25,
  'cursor': 'pointer'
});
