...
bottomArea.text(171, 240, 'ね').click(playAud01).attr({
  'font-size': 100,
  'cursor': 'pointer'
});
...
h_neko.use().transform('t135 390').click(playAud02).appendTo(bottomArea).attr({
  'cursor': 'pointer'
});

var t12 = bottomArea.text(186, 520, ['ね', 'こ', '고양이']).click(playAud02).attr({
  'font-size': 25,
  'cursor': 'pointer'
});
