...
bottomArea.text(171, 240, 'カ').click(playAud01).attr({
  'font-size': 100,
  'cursor': 'pointer'
});
...
g_kamera.use().transform('t130, 390').click(playAud02).appendTo(bottomArea).attr({
  'cursor': 'pointer'
});

var t12 = bottomArea.text(165, 520, ['カ', 'メラ', '카메라']).click(playAud02).attr({
  'font-size': 25,
  'cursor': 'pointer'
});
