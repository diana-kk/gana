...
bottomArea.text(167, 240, 'そ').click(playAud01).attr({
  'font-size': 100,
  'cursor': 'pointer'
});
...
h_souji.use().transform('t135 385').click(playAud02).appendTo(bottomArea).attr({
  'cursor': 'pointer'
});

var t12 = bottomArea.text(180, 520, ['そ', 'うじ', '청소']).click(playAud02).attr({
  'font-size': 25,
  'cursor': 'pointer'
});
