...
bottomArea.text(171, 240, 'ホ').click(playAud01).attr({
  'font-size': 100,
  'cursor': 'pointer'
});
...
g_hoteru.use().transform('t140 385').click(playAud02).appendTo(bottomArea).attr({
  'cursor': 'pointer'
});

var t12 = bottomArea.text(180, 520, ['ホ', 'テル', '호텔']).click(playAud02).attr({
  'font-size': 25,
  'cursor': 'pointer'
});
