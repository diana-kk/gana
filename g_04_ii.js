...
bottomArea.text(171, 240, 'イ').click(playAud01).attr({
  'font-size': 100,
  'cursor': 'pointer'
});
...
g_igirisu.use().transform('t135, 395').click(playAud02).appendTo(bottomArea).attr({
  'cursor': 'pointer'
});

var t12 = bottomArea.text(165, 520, ['イ', 'ギリス', '영국']).click(playAud02).attr({
  'font-size': 25,
  'cursor': 'pointer'
});
