...
bottomArea.text(171, 240, 'ろ').click(playAud01).attr({
  'font-size': 100,
  'cursor': 'pointer'
});
...
h_roba.use().transform('t130 390').click(playAud02).appendTo(bottomArea).attr({
  'cursor': 'pointer'
});

var t12 = bottomArea.text(186, 520, ['ろ', 'ば', '당나귀']).click(playAud02).attr({
  'font-size': 25,
  'cursor': 'pointer'
});
