...
bottomArea.text(171, 240, 'ツ').click(playAud01).attr({
  'font-size': 100,
  'cursor': 'pointer'
});
...
g_tuna.use().transform('t130 395').click(playAud02).appendTo(bottomArea).attr({
  'cursor': 'pointer'
});

var t12 = bottomArea.text(190, 520, ['ツ', 'ナ', '참치']).click(playAud02).attr({
  'font-size': 25,
  'cursor': 'pointer'
});
