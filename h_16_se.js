...
bottomArea.text(171, 240, 'せ').click(playAud01).attr({
  'font-size': 100,
  'cursor': 'pointer'
});
...
h_seki.use().transform('t135 390').click(playAud02).appendTo(bottomArea).attr({
  'cursor': 'pointer'
});

var t12 = bottomArea.text(200, 520, ['せ', 'き', '좌석']).click(playAud02).attr({
  'font-size': 25,
  'cursor': 'pointer'
});
