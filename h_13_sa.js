...
bottomArea.text(171, 240, 'さ').click(playAud01).attr({
  'font-size': 100,
  'cursor': 'pointer'
});
...
h_saji.use().transform('t135 390').click(playAud02).appendTo(bottomArea).attr({
  'cursor': 'pointer'
});

var t12 = bottomArea.text(185, 520, ['さ', 'じ', '숟가락']).click(playAud02).attr({
  'font-size': 25,
  'cursor': 'pointer'
});
