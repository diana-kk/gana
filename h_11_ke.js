...
bottomArea.text(171, 240, 'け').click(playAud01).attr({
  'font-size': 100,
  'cursor': 'pointer'
});
...
h_kega.use().transform('t140, 385').click(playAud02).appendTo(bottomArea).attr({
  'cursor': 'pointer'
});

var t12 = bottomArea.text(200, 520, ['け', 'が', '상처']).click(playAud02).attr({
  'font-size': 25,
  'cursor': 'pointer'
});
