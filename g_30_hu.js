...
bottomArea.text(171, 240, 'フ').click(playAud01).attr({
  'font-size': 100,
  'cursor': 'pointer'
});
...
g_huruutu.use().transform('t140 385').click(playAud02).appendTo(bottomArea).attr({
  'cursor': 'pointer'
});

var t12 = bottomArea.text(160, 520, ['フ', 'ルーツ', '과일']).click(playAud02).attr({
  'font-size': 25,
  'cursor': 'pointer'
});
