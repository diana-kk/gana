...
bottomArea.text(171, 240, 'て').click(playAud01).attr({
  'font-size': 100,
  'cursor': 'pointer'
});
...
h_te.use().transform('t135 385').click(playAud02).appendTo(bottomArea).attr({
  'cursor': 'pointer'
});

var t12 = bottomArea.text(210, 520, ['て', '손']).click(playAud02).attr({
  'font-size': 25,
  'cursor': 'pointer'
});
