...
bottomArea.text(171, 240, 'コ').click(playAud01).attr({
  'font-size': 100,
  'cursor': 'pointer'
});
...
g_koora.use().transform('t140, 387').click(playAud02).appendTo(bottomArea).attr({
  'cursor': 'pointer'
});

var t12 = bottomArea.text(175, 520, ['コ', 'ーラ', '콜라']).click(playAud02).attr({
  'font-size': 25,
  'cursor': 'pointer'
});
