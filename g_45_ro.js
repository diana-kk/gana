...
bottomArea.text(171, 240, 'ロ').click(playAud01).attr({
  'font-size': 100,
  'cursor': 'pointer'
});
...
g_roopu.use().transform('t130 390').click(playAud02).appendTo(bottomArea).attr({
  'cursor': 'pointer'
});

var t12 = bottomArea.text(186, 520, ['ロ', 'ープ', '로프']).click(playAud02).attr({
  'font-size': 25,
  'cursor': 'pointer'
});
