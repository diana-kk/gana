...
bottomArea.text(171, 240, 'ヤ').click(playAud01).attr({
  'font-size': 100,
  'cursor': 'pointer'
});
...
g_taiya.use().transform('t130 390').click(playAud02).appendTo(bottomArea).attr({
  'cursor': 'pointer'
});

var t12 = bottomArea.text(175, 520, ['タイ', 'ヤ', '타이어']).click(playAud02).attr({
  'font-size': 25,
  'fill': 'gray',
  'cursor': 'pointer'
});
