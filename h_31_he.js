...
bottomArea.text(171, 240, 'へ').click(playAud01).attr({
  'font-size': 100,
  'cursor': 'pointer'
});
...
h_heso.use().transform('t140 380').click(playAud02).appendTo(bottomArea).attr({
  'cursor': 'pointer'
});

var t12 = bottomArea.text(200, 520, ['へ', 'そ', '배꼽']).click(playAud02).attr({
  'font-size': 25,
  'cursor': 'pointer'
});
