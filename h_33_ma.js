...
bottomArea.text(171, 240, 'ま').click(playAud01).attr({
  'font-size': 100,
  'cursor': 'pointer'
});
...
h_machi.use().transform('t130 390').click(playAud02).appendTo(bottomArea).attr({
  'cursor': 'pointer'
});

var t12 = bottomArea.text(200, 520, ['ま', 'ち', '마을']).click(playAud02).attr({
  'font-size': 25,
  'cursor': 'pointer'
});
