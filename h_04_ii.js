...
bottomArea.text(171, 240, 'い').click(playAud01).attr({
  'font-size': 100,
  'cursor': 'pointer'
});
...
h_ie.use().transform('t135, 395').click(playAud02).appendTo(bottomArea).attr({
  'cursor': 'pointer'
});

var t12 = bottomArea.text(200, 520, ['い', 'え', '집']).click(playAud02).attr({
  'font-size': 25,
  'cursor': 'pointer'
});
