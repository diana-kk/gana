...
bottomArea.text(171, 240, 'れ').click(playAud01).attr({
  'font-size': 100,
  'cursor': 'pointer'
});
...
h_rennga.use().transform('t130 390').click(playAud02).appendTo(bottomArea).attr({
  'cursor': 'pointer'
});

var t12 = bottomArea.text(180, 520, ['れ', 'んが', '벽돌']).click(playAud02).attr({
  'font-size': 25,
  'cursor': 'pointer'
});
