...
bottomArea.text(171, 240, 'た').click(playAud01).attr({
  'font-size': 100,
  'cursor': 'pointer'
});
...
h_taco.use().transform('t135 390').click(playAud02).appendTo(bottomArea).attr({
  'cursor': 'pointer'
});

var t12 = bottomArea.text(200, 520, ['た', 'こ', '문어']).click(playAud02).attr({
  'font-size': 25,
  'cursor': 'pointer'
});
