...
bottomArea.text(171, 240, 'な').click(playAud01).attr({
  'font-size': 100,
  'cursor': 'pointer'
});
...
h_nashi.use().transform('t145 390').click(playAud02).appendTo(bottomArea).attr({
  'cursor': 'pointer'
});

var t12 = bottomArea.text(200, 520, ['な', 'し', '배']).click(playAud02).attr({
  'font-size': 25,
  'cursor': 'pointer'
});
