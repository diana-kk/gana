...
bottomArea.text(171, 240, 'チ').click(playAud01).attr({
  'font-size': 100,
  'cursor': 'pointer'
});
...
g_tikinn.use().transform('t135 385').click(playAud02).appendTo(bottomArea).attr({
  'cursor': 'pointer'
});

var t12 = bottomArea.text(180, 520, ['チ', 'キン', '치킨']).click(playAud02).attr({
  'font-size': 25,
  'cursor': 'pointer'
});
