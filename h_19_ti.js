...
bottomArea.text(171, 240, 'ち').click(playAud01).attr({
  'font-size': 100,
  'cursor': 'pointer'
});
...
h_titi.use().transform('t135 385').click(playAud02).appendTo(bottomArea).attr({
  'cursor': 'pointer'
});

var t12 = bottomArea.text(200, 520, ['ち', 'ち', '아빠']).click(playAud02).attr({
  'font-size': 25,
  'cursor': 'pointer'
});
