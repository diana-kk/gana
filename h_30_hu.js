...
bottomArea.text(171, 240, 'ふ').click(playAud01).attr({
  'font-size': 100,
  'cursor': 'pointer'
});
...
h_huku.use().transform('t140 385').click(playAud02).appendTo(bottomArea).attr({
  'cursor': 'pointer'
});

var t12 = bottomArea.text(200, 520, ['ふ', 'く', '옷']).click(playAud02).attr({
  'font-size': 25,
  'cursor': 'pointer'
});
