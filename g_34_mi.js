...
bottomArea.text(171, 240, 'ミ').click(playAud01).attr({
  'font-size': 100,
  'cursor': 'pointer'
});
...
g_miruku.use().transform('t130 390').click(playAud02).appendTo(bottomArea).attr({
  'cursor': 'pointer'
});

var t12 = bottomArea.text(185, 520, ['ミ', 'ルク', '우유']).click(playAud02).attr({
  'font-size': 25,
  'cursor': 'pointer'
});
