...
bottomArea.text(171, 240, 'ル').click(playAud01).attr({
  'font-size': 100,
  'cursor': 'pointer'
});
...
g_rubii.use().transform('t130 390').click(playAud02).appendTo(bottomArea).attr({
  'cursor': 'pointer'
});

var t12 = bottomArea.text(186, 520, ['ル', 'ビー', '루비']).click(playAud02).attr({
  'font-size': 25,
  'cursor': 'pointer'
});
