...
bottomArea.text(171, 240, 'ハ').click(playAud01).attr({
  'font-size': 100,
  'cursor': 'pointer'
});
...
g_hamu.use().transform('t130 385').click(playAud02).appendTo(bottomArea).attr({
  'cursor': 'pointer'
});

var t12 = bottomArea.text(200, 520, ['ハ', 'ム', '햄']).click(playAud02).attr({
  'font-size': 25,
  'cursor': 'pointer'
});
